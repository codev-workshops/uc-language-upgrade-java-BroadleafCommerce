...
public class ContentProcessor extends AbstractModelVariableModifierProcessor {
    ...
    public ContentProcessor(String elementName) {
        super(DIALECT_PREFIX, elementName, 10000);
    }
    ...
    @Override
    protected void modifyModelAttributes(final ITemplateContext context, IProcessableElementTag tag,
     ...
     * @return
     */
    protected Map<String, Object> buildMvelParameters(HttpServletRequest request, ITemplateContext context,
