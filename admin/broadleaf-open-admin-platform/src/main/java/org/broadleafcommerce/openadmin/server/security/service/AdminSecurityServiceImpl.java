...
public class AdminSecurityServiceImpl implements AdminSecurityService {
    ...
    /**
     * <p>Set by {@link #setupPasswordEncoder()} from the blAdminPasswordEncoder bean.
     */
    ...
    /**
     * <p>Sets {@link #passwordEncoderNew} based on the type of {@link #passwordEncoderBean}.
     *
     ...
     *
     * @throws NoSuchBeanDefinitionException if {@link #passwordEncoderBean} is null or not a PasswordEncoder
     */
    @PostConstruct
     ...
     * Additionally, having the encoding algorithm handle the salt internally reduces code complexity and dependencies such as an external salt source.
     *
