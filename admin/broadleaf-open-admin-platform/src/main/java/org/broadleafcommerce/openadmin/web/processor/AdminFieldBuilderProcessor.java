...
public class AdminFieldBuilderProcessor extends AbstractElementTagProcessor {
    ...
    public AdminFieldBuilderProcessor() {
        super(TemplateMode.HTML, BLCAdminDialect.DEFAULT_PREFIX, "admin_field_builder", true, null, false, 100);
    }
    ...
    protected void doProcess(ITemplateContext context, IProcessableElementTag tag, IElementTagStructureHandler structureHandler) {
        ...
        // The host element is intentionally left in place (mirrors the Thymeleaf 2 removeHostElement=false behavior);
        // the fieldWrapper local variable is exposed to the element body.
