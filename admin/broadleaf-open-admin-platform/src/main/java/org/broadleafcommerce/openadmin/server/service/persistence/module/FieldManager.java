...
public class FieldManager {
    ...
    public Field getField(Class<?> clazz, String fieldName) throws IllegalStateException {
        ...
        SessionFactory sessionFactory = persistenceManager.getDynamicEntityDao().getDynamicDaoHelper().
                getSessionFactory(persistenceManager.getDynamicEntityDao().getStandardEntityManager());
        BLCFieldUtils fieldUtils = new BLCFieldUtils(sessionFactory, true,
                persistenceManager.getDynamicEntityDao().useCache(), entityConfiguration,
