...
public class CustomerServiceImpl implements CustomerService {
    ...
    /**
     * <p>The {@link PasswordEncoder} used to hash and verify customer passwords. Self-salting algorithms such as
     * bcrypt are expected; salting is handled internally by the encoder.
     */
    protected PasswordEncoder passwordEncoderNew;

    /**
     * <p>This is simply a placeholder to be used by {@link #setupPasswordEncoder()} to resolve the configured
     ...
     *
     * @deprecated the {@link PasswordEncoder} handles salting internally, this will be removed in 4.2
     */
    @Deprecated
    ...
    /**
     * <p>Sets {@link #passwordEncoderNew} from {@link #passwordEncoderBean}.
     *
     ...
     *
     * @throws NoSuchBeanDefinitionException if {@link #passwordEncoderBean} is null or not a {@link PasswordEncoder}
     */
    @PostConstruct
     ...
     *
     * <p>This method will set the {@link #passwordEncoderNew} member variable by calling {@link #setupPasswordEncoder()}
     *
     * @param passwordEncoder Spring Security's {@link PasswordEncoder}
     */
    ...
    /**
     * Delegates to {@link #encodePassword(String)}; the salt argument is ignored now that the {@link PasswordEncoder}
     * handles salting internally.
     *
     * @deprecated the {@link org.springframework.security.crypto.password.PasswordEncoder PasswordEncoder} handles salting internally, this will be removed in 4.2
     *
     * @param rawPassword the unencoded password
     * @param salt the (ignored) optional salt
    ...
    /**
     * Delegates to {@link #isPasswordValid(String, String)}; the salt argument is ignored now that the
     * {@link PasswordEncoder} handles salting internally.
     *
     * @deprecated the {@link org.springframework.security.crypto.password.PasswordEncoder PasswordEncoder} handles salting internally, this will be removed in 4.2
     *
     * @param rawPassword the unencoded password
    ...
    protected CustomerForgotPasswordSecurityToken checkPasswordResetToken(String token, Customer customer, GenericResponse response) {
        ...
        if (!response.getHasErrors()) {
            if (customer == null) {
                // a Customer is required now that the deprecated PasswordEncoder support has been removed
