 ...
 * @author apazzolini
 */
public class RemoveFacetValuesLinkProcessor extends AbstractAttributeModifierProcessor {
    ...
    public RemoveFacetValuesLinkProcessor() {
        super("removefacetvalueslink", 10000);
    }
    ...
    protected Map<String, String> getModifiedAttributes(ITemplateContext context, IProcessableElementTag tag,
        ...
        SearchFacetDTO facet = (SearchFacetDTO) evaluate(context, attributeValue);
