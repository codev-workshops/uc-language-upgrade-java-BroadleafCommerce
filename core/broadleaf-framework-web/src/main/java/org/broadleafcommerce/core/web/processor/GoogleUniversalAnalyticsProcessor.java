...
public class GoogleUniversalAnalyticsProcessor extends AbstractElementTagProcessor {
    ...
    protected static final int PRECEDENCE = 0;
    ...
    public GoogleUniversalAnalyticsProcessor() {
        super(TemplateMode.HTML, BLCDialect.DEFAULT_PREFIX, "google_universal_analytics", true, null, false, PRECEDENCE);
    }
    
    public GoogleUniversalAnalyticsProcessor(String elementName) {
        super(TemplateMode.HTML, BLCDialect.DEFAULT_PREFIX, elementName, true, null, false, PRECEDENCE);
    }
