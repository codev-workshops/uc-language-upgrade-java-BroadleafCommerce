 ...
 * Test-classpath override: directly reads from HttpServletRequest to avoid
 * Spring 5.3 ServletWebRequest scoping issues in test contexts.
 */
...
public class BroadleafRequestCustomerResolverImpl implements ApplicationContextAware, BroadleafRequestCustomerResolver {
    ...
    public Object getCustomer(HttpServletRequest request) {
        // Direct read from HttpServletRequest avoids ServletWebRequest scoping issues
        return request.getAttribute(getCustomerRequestAttributeName());
    }
    ...
    public Object getCustomer(WebRequest request) {
        if (request instanceof ServletWebRequest) {
            ...
            return httpRequest.getAttribute(getCustomerRequestAttributeName());
        }
