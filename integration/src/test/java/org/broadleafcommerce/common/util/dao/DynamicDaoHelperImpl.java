...
/**
 * Hibernate 5.6 compatible replacement for DynamicDaoHelperImpl.
 * Replaces getAllClassMetadata() (removed in 5.6) with metamodel API.
 */
    ...
    public Class<?>[] getAllPolymorphicEntitiesFromCeiling(Class<?> ceilingClass, SessionFactory sessionFactory,
        ...
        synchronized(LOCK_OBJECT) {
            ...
            if (cache == null) {
                ...
                // Use metamodel API instead of removed getAllClassMetadata()
