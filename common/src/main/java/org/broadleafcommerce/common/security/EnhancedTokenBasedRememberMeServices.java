...
public class EnhancedTokenBasedRememberMeServices extends TokenBasedRememberMeServices {
    ...
    protected void setCookie(String[] tokens, int maxAge, HttpServletRequest request, HttpServletResponse response) {
        CookieCapturingResponse capturingResponse = new CookieCapturingResponse(response);
    ...
    /**
     * Captures the cookie that {@link TokenBasedRememberMeServices} attempts to set so that it can be written through
     * {@link CookieUtils} instead.
     */
    private static class CookieCapturingResponse extends HttpServletResponseWrapper {

        private Cookie tempCookie;

        CookieCapturingResponse(HttpServletResponse response) {
            super(response);
        }
