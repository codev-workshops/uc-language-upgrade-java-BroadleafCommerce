...
public abstract class AbstractGeneratedResourceHandler implements Ordered {
    ...
    public Resource getResource(final String path, final List<Resource> locations) {
        Object e = getGeneratedResourceCache().get(path);
        Resource r = null;
        if (e == null) {
        ...
        if (e == null) {
            shouldGenerate = true;
        } else if (e instanceof GeneratedResource
                && isCachedResourceExpired((GeneratedResource) e, path, locations)) {
            shouldGenerate = true;
        } else {
            r = (Resource) e;
        }
    ...
    protected Cache<Object, Object> getGeneratedResourceCache() {
        if (generatedResourceCache == null) {
            ...
            if (generatedResourceCache == null) {
                generatedResourceCache = cacheManager.createCache("generatedResourceCache",
